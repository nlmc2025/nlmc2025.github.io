...
const config = {
    serverInfo: {
        ...
        serverName: "Nasi Lemak Minecraft", /*Server name*/
        serverIp: "nasi.lemak.xyz", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "916690894374207559" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
